...
public class Inputs {
    ...
    public static int[][] getDay13(){
        String[] sArr = day13.split("\n");
        String[][] dsArr = new String[sArr.length][];
        for (int i = 0; i < sArr.length; i++){
            dsArr[i] = sArr[i].split(": ");
        }
        return daStringtoDAInt(dsArr);
    }

    public static int[][] daStringtoDAInt(String[][] input){
        int[][] dsArr = new int[input.length][];

        for (int i = 0; i < input.length; i++){
            dsArr[i] = new int[input[i].length];
            for (int j = 0; j < input[i].length; j++){
                dsArr[i][j] = Integer.parseInt(input[i][j]);
            }
        }
        return dsArr;
    }

    public static String day13Test =
            "0: 3\n" +
            "1: 2\n" +
            "4: 4\n" +
            "6: 4";
    ...
    public static int[] aStringToAInt(String[] s){
